...
(function($){
	...
	_view = {
		addEditBtn: function(setting, node) {
			...
			editStr = "<span class='" + consts.className.BUTTON_NO_IMG + " edit' id='" + node.tId + consts.id.EDIT + "' title='"+tools.apply(setting.edit.renameTitle, [setting.treeId, node], setting.edit.renameTitle)+"' treeNode"+consts.id.EDIT+" style='display:none;'>编辑</span>";
			aObj.append(editStr);
		...
		addRemoveBtn: function(setting, node) {
			...
			var aObj = $("#" + node.tId + consts.id.A),
			removeStr = "<span class='" + consts.className.BUTTON_NO_IMG + " remove' id='" + node.tId + consts.id.REMOVE + "' title='"+tools.apply(setting.edit.removeTitle, [setting.treeId, node], setting.edit.removeTitle)+"' treeNode"+consts.id.REMOVE+" style='display:none;'>删除</span>";
		...
		editNode: function(setting, node) {
			...
			view.selectNode(setting, node, false);
			// 增加输入框最大字数限制
			$("#" + node.tId + consts.id.SPAN).html("<input maxlength='"+ setting.edit.maxLength +"' type=text class='rename' id='" + node.tId + consts.id.INPUT + "' treeNode" + consts.id.INPUT + " >");
